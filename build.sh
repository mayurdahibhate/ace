...
g++ -c -o sphere.o -I /usr/include/ -I./include/ src/sphere.cpp

g++ -o app -L/usr/lib/x86_64-linux-gnu app.o LoadShaders.o window_manager.o mesh.o texture.o sphere.o -L ./src/ -lX11 -lGL -lGLEW
